module.exports.eventCertificate = (user, eventName, prize, images, year, date) => {
    ...
    <h1 style="color: rgb(0, 94, 255); text-align: center; font-weight: 700; margin: 21px 0px 10px 150px;">
        STUDENT CLUBS ASSOCIATION Of CollegeClubs<br> ANANTHAPURAMU - 515002
    </h1>
    <div style="display: flex; flex-direction: row; justify-content: space-between;">
        <img src="https://res.cloudinary.com/delc5g3p5/image/upload/v1729762295/Clubs/n3eov9yrilskbwzr4006.png"
            alt="CollegeClubs-log" style="width: 190px; height: 190px; margin-left: 50px;">
        ...
        <img src="https://res.cloudinary.com/delc5g3p5/image/upload/v1729762294/Clubs/sdowztfbu0qi5ztpncz9.webp"
            alt="CollegeClubs-logo" style="width: 150px; height: 150px; margin-right: 100px; margin-top: 10px;">
    </div>
        ...
        <div>
            ...
            <div
                ...
                <div>
                    ...
                    <strong>Officer In-Charge</strong><br> of Student Clubs<br> College Clubs
                </div>
                <div>
                    <img src=${images[1]}
                        alt="student-coordinator-sign" style="width: 80%;">
                    <strong>Student Coordinator</strong><br> of Student Clubs<br> College Clubs
                </div>
                <div>
                    <img src=${images[2]}
                        alt="Principal-sign" style="width: 80%;">
                    <strong>Principal</strong><br> College Clubs
                </div>
            </div>
        </div>
    </div>
