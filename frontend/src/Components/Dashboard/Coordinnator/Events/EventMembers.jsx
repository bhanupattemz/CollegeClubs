import "../../Admin/Events/EventMembers.css"
...
export default function EventMembers() {
            ...
            buttons: [
                {
                    ...
                    onClick: async () => {
                        try {
                            ...
                            toast.success("Member removed from the event successfully!")
    ...
    return <CoordinatorSetup current={"events"} option={"members"} element={
