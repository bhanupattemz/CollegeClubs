...
import { adminCreateCarousel } from "../../../../Actions/carouselImgsActions"
...
export default function CreateCarousel() {
    ...
    const formSubmitHandler = (e) => {
        ...
        if (!formData.image) {
            ...
            dispatch(adminCreateCarousel(fd))
        }
    }
    useEffect(() => {
        if (success) {
    ...
    if (loading) return <AdminSetUp current={"carousel"} option={"Create"} element={<Loading />} />
    return <AdminSetUp current={"carousel"} option={"Create"} element={
